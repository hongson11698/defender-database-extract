...
-- Command line: db 092023\av_db\lua\__MacOSXplatSysIOAPITestA\ObMpAttributes\0x000000d1_luac 

-- params : ...
-- function num : 0
local l_0_0 = (mp.getfilename)(mp.FILEPATH_QUERY_FULL)
if l_0_0 ~= "/private/tmp/0c02a078-ea6f-4635-b4c5-be81241d7bb9-sysiotestfile-1.txt" then
  return mp.CLEAN
end
