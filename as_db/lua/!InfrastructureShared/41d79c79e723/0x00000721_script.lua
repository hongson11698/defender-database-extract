...
-- Command line: db 092023\as_db\lua\!InfrastructureShared\41d79c79e723\0x00000721_luac 
...
if l_0_4 ~= nil and (sysio.IsFileExists)(l_0_4) and checkFileLastWriteTime(l_0_4, 3600) and not (mp.IsKnownFriendlyFile)(l_0_4, true, false) then
  ...
  for l_0_9,l_0_10 in ("\\users\\public\\.+")("\\users\\.+\\appdata\\roaming\\.+") do
    ...
    -- DECOMPILER ERROR at PC75: Overwrote pending register: R12 in 'AssignReg'

    if ("\\users\\.+\\appdata\\local\\temp\\bnz.+")("\\device\\cdrom.+") then
      return mp.INFECTED
    end
  end
end
