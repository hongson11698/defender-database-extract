...
-- Command line: db 092023\as_db\lua\!InfrastructureShared\154b3b924593d\0x000081e8_luac 
  ...
  do
    return l_1_6
      ...
      for l_0_8,l_0_9 in ipairs(l_0_4) do
        local l_0_5 = {"powershell.exe"}
        -- DECOMPILER ERROR at PC63: Confused about usage of register: R9 in 'UnsetPending'

        if l_0_3:find("\\users\\.+\\appdata\\local\\temp\\bnz.+") and IsProcNameInParentProcessTree("BM", l_0_5) then
          (mp.ReportLowfi)(l_0_3, 1883884361)
          return mp.INFECTED
        end
      end
    end
