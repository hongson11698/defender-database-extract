...
-- Command line: db 092023\as_db\lua\!InfrastructureShared\41b3f5803f3c\0x0000038d_luac 
...
do
  ...
  if IsKeyInRollingQueue("DroppedByPossibleRemotelyCreatedProc", l_0_3, true) then
