...
-- Command line: db 092023\as_db\lua\!InfrastructureShared\44b3994f586e\0x00000876_luac 
...
do
  ...
  if l_0_4 then
    for l_0_8,l_0_9 in ipairs(l_0_4) do
      ...
      if (string.find)(R7_PC38, ":\\users\\", 1, true) and (MpCommon.QueryPersistContext)(R7_PC38, "SystemDropToUserProfile.A") then
        l_0_5 = R7_PC38
        break
      end
    end
