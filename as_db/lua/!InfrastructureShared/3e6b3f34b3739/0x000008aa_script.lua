...
-- Command line: db 092023\as_db\lua\!InfrastructureShared\3e6b3f34b3739\0x000008aa_luac 
        ...
        do
          ...
          do
            ...
            if this_sigattrlog[12] and (this_sigattrlog[12]).matched then
              ...
              if not (this_sigattrlog[12]).matched or not (this_sigattrlog[12]).ppid then
                return mp.CLEAN
              end
              ...
              local l_0_14 = nil
              AppendToRollingQueue((string.format)("susp_regions:%s", l_0_11.ppid), l_0_13)
              ;
              (bm.trigger_sig)("ScanSuspiciousRegions", l_0_14, l_0_11.ppid)
              return mp.INFECTED
            end
          end
        end
