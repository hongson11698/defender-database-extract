...
-- Command line: db 092023\as_db\lua\!InfrastructureShared\Unknowcategory\0x0000021b_luac 
...
if (this_sigattrlog[1]).matched and (this_sigattrlog[2]).matched and (this_sigattrlog[3]).matched and (this_sigattrlog[4]).matched and (this_sigattrlog[5]).matched then
  ...
  if l_0_5 == nil or l_0_7 == nil or l_0_9 == nil or l_0_11 == nil or l_0_13 == nil then
    return mp.CLEAN
  end
  if l_0_6 == nil or l_0_8 == nil or l_0_10 == nil or l_0_12 == nil or l_0_14 == nil then
    return mp.CLEAN
  end
