...
-- Command line: db 092023\as_db\lua\!InfrastructureShared\Unknowcategory\0x0000129c_luac 
...
GetPathExclusions = function()
  ...
  l_3_0["%programfiles%\\AppSense\\Application Manager\\Agent\\AMMessage.exe"] = 2
  l_3_0["%programfiles%\\Microsoft OneDrive\\*\\FileCoAuth.exe"] = 2
  l_3_0["%programfiles%\\PolicyPak\\Browser Router\\Client\\PPBRAgent.exe"] = 2
  l_3_0["%programfiles%\\Nitro\\Pro\\*\\NxPdfCreator.exe"] = 2
  l_3_0["%programfiles%\\AnyShare\\sharetool.exe"] = 2
  l_3_0["%programfiles%\\PTI\\FusionPro\\ProdReActivate.exe"] = 2
  l_3_0["%programfiles%\\Nitro\\Pro\\*\\metrics_tool.exe"] = 2
  l_3_0["%programfiles%\\Unify\\Fusion for MS Office\\FusionPlugins\\FusionExecutor.exe"] = 2
  l_3_0["%programfiles%\\ELO Digital Office GmbH\\ELO Java Client\\EloActivateJC.exe"] = 2
  l_3_0["%programfiles%\\Tracker Software\\PDF-XChange Standard\\pdfSaver.exe"] = 2
  l_3_0["%programfiles%\\PDF-XChange\\PDF-XChange Standard\\pdfSaver.exe"] = 2
  ...
  l_3_0["%programfiles(x86)%\\KnowBe4\\Second Chance\\knowbe4.secondchance.userdialog.exe"] = 2
  l_3_0["%programfiles(x86)%\\SamsungPrinterLiveUpdateInstaller\\LUMgr.exe"] = 2
  l_3_0["%programfiles(x86)%\\Mozilla Thunderbird\\thunderbird.exe"] = 2
  l_3_0["%programfiles(x86)%\\Spirion\\IdentityFinderCmd.exe"] = 2
  l_3_0["%programfiles(x86)%\\Citrix\\System32\\iexplore.exe"] = 2
  l_3_0["%programfiles(x86)%\\Citrix\\HDX\\bin\\iexplore.exe"] = 2
  l_3_0["%programfiles(x86)%\\FactSet\\FDSBrowser.exe"] = 2
  l_3_0["%programfiles(x86)%\\SHARP\\Printer Status Monitor\\Smon.exe"] = 2
  l_3_0["%programfiles(x86)%\\OpenText\\Office Editor\\OTEditTray.exe"] = 2
  l_3_0["%programfiles(x86)%\\PTI\\FusionPro\\ProdReActivate.exe"] = 2
  l_3_0["%programfiles(x86)%\\NEC\\InfoCageFileShell"] = 2
  l_3_0["%programfiles(x86)%\\Nuance\\Power PDF ??\\bin\\SendMail.exe"] = 2
  l_3_0["%programfiles(x86)%\\IBM\\Notes\\notes.exe"] = 2
  l_3_0["%programfiles(x86)%\\FUJIFILM\\DocumentMonitor\\DocMon\\GetJCID.exe"] = 2
  l_3_0["%programfiles(x86)%\\Unify\\Fusion for MS Office\\FusionPlugins\\FusionExecutor.exe"] = 2
  l_3_0["%programfiles(x86)%\\Kofax\\*\\bin\\SendMail.exe"] = 2
  l_3_0["%programfiles(x86)%\\JustSystems\\ATOK??\\ATFSVR??.EXE"] = 2
  ...
  l_3_0["%windir%\\system32\\mspaint.exe"] = 2
  l_3_0["%windir%\\system32\\BuCAppNT.exe"] = 2
  l_3_0["%windir%\\system32\\BuMAppNT.exe"] = 2
  ...
  local l_3_1 = "%windir%\\system32\\fsiso.exe"
  l_3_0[l_3_1] = 2
  l_3_1 = "%userprofile%\\appdata\\local\\google\\chrome"
  l_3_0[l_3_1] = 1
  l_3_1 = "%userprofile%\\appdata\\local\\microsoft\\onedrive"
  l_3_0[l_3_1] = 1
  l_3_1 = "%userprofile%\\appdata\\locallow\\copitrak"
  l_3_0[l_3_1] = 1
