...
-- Command line: db 092023\as_db\lua\!InfrastructureShared\Unknowcategory\0x00000209_luac 
...
do
  ...
  do
    if not (this_sigattrlog[5]).matched or (this_sigattrlog[6]).matched then
      local l_0_1, l_0_2, l_0_3, l_0_4 = (string.lower)((this_sigattrlog[5]).utf8p1)
    end
