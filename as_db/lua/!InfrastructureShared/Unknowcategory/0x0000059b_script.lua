...
-- Command line: db 092023\as_db\lua\!InfrastructureShared\Unknowcategory\0x0000059b_luac 

-- params : ...
-- function num : 0
if (mp.getfilesize)() > 25000000 then
  return mp.CLEAN
end
...
if (string.find)(l_0_0, "/download_ss_scanpath", 1, true) then
  return mp.CLEAN
end
