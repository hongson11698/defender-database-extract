...
-- Command line: db 092023\as_db\lua\!InfrastructureShared\Unknowcategory\0x000005a2_luac 

-- params : ...
-- function num : 0
if not (mp.get_mpattribute)("BM_ELF_EXEC_FILE") and not (mp.get_mpattribute)("BM_ELF_DYN_FILE") then
  return mp.CLEAN
end
