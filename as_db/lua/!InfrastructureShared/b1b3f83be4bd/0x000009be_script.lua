...
-- Command line: db 092023\as_db\lua\!InfrastructureShared\b1b3f83be4bd\0x000009be_luac 
...
detectionLog = {}
    ...
    if l_0_12 <= l_0_10 then
      (bm.add_related_string)("officegen", safeJsonSerialize(l_0_22), bm.RelatedStringBMReport)
      return mp.INFECTED
    end
    return mp.CLEAN
  end
