...
-- Command line: db 092023\as_db\lua\!InfrastructureShared\230b3a1a3a06e\0x00000196_luac 
...
, function(l_3_0)
  ...
  do
    ...
    do
      ...
      R17_PC96("GPO-scheduledtasks-info", safeJsonSerialize({gpo_guid = R17_PC96, command_lines = l_0_19}), bm.RelatedStringBMReport)
