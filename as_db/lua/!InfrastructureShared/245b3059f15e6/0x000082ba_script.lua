...
-- Command line: db 092023\as_db\lua\!InfrastructureShared\245b3059f15e6\0x000082ba_luac 
...
, {SIG_CONTEXT = "BM", CONTENT_SOURCE = "USB_POWERSHELL_ONE", PROCESS_CONTEXT = "powershell.exe", FILELESS = "true", CMDLINE_URL = "true"}
