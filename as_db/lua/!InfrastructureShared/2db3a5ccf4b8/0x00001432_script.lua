...
-- Command line: db 092023\as_db\lua\!InfrastructureShared\2db3a5ccf4b8\0x00001432_luac 
...
do
  ...
  if l_0_0 ~= nil then
    ...
    for l_0_9,l_0_10 in ipairs(l_0_5) do
      ...
      TrackPidAndTechniqueBM(R7_PC25.ppid, "T1562.001", "DefenseEvasion_PtraceScopeToggle")
    end
    addRelatedProcess()
    reportRelatedBmHits()
    return mp.INFECTED
