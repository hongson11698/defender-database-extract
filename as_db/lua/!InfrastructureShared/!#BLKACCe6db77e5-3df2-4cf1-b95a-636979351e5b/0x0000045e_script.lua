...
-- Command line: db 092023\as_db\lua\!InfrastructureShared\!#BLKACCe6db77e5-3df2-4cf1-b95a-636979351e5b\0x0000045e_luac 

-- params : ...
-- function num : 0
if not (mp.get_mpattribute)("SCPT:Trojan:JS/WmiActiveScriptConsumer.A!ams") then
  return mp.CLEAN
end
