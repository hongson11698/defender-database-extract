...
-- Command line: db 092023\as_db\lua\!InfrastructureShared\!#LuaContextIOAVHasSoftbiturlUrl\0x00000058_luac 

-- params : ...
-- function num : 0
local l_0_0 = (mp.IOAVGetDownloadUrl)()
if l_0_0:find("softbiturl.com/", 1, true) then
  local l_0_1 = (mp.getfilename)(mp.FILEPATH_QUERY_LOWERCASE)
  local l_0_2 = "IOAVHasSoftbiturlUrl"
