...
-- Command line: db 092023\as_db\lua\!InfrastructureShared\76b34d0c56c1\0x0000076f_luac 
...
do
  ...
  local l_0_3 = nil
  if l_0_3 ~= nil and (string.find)(l_0_3, "/create", 1, true) and (string.find)(l_0_3, "cscript", 1, true) then
    local l_0_4 = nil
  ...
  return l_1_1
    ...
    for l_0_9,l_0_10 in ipairs(l_0_5) do
      local l_0_6 = {SIG_CONTEXT = "BM", CONTENT_SOURCE = "CSCRIPT_SCHTASK_ISSERVER", PROCESS_CONTEXT = "schtasks.exe", FILELESS = "true", CMDLINE_URL = "true"}
