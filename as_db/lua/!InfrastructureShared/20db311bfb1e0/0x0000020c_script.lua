...
-- Command line: db 092023\as_db\lua\!InfrastructureShared\20db311bfb1e0\0x0000020c_luac 
...
if l_0_6 == nil then
  ...
  if l_0_6 > 9000000 and l_0_6 < 13000000 and l_0_5 > 240 and l_0_5 < 320 then
  ...
  if l_0_6 > 35000000 and l_0_6 < 75000000 and l_0_5 > 1000 then
    (bm.add_related_string)("lsassReadBytes", tostring(l_0_6), bm.RelatedStringBMReport)
    ;
    (bm.add_related_string)("lsassReadsCount", tostring(l_0_5), bm.RelatedStringBMReport)
    return mp.INFECTED
