...
-- Command line: db 092023\as_db\lua\!InfrastructureShared\!#LUAAnomalyTencode2\0x0000034c_luac 
...
if l_0_0 ~= nil and #l_0_0 > 0 then
  for l_0_4,l_0_5 in ipairs(l_0_0) do
    ...
    local l_0_7 = (MpCommon.AnomalyEventLookup)("AnomalyTencode2", "Tencode2TableMarker", 100)
    if l_0_7 == nil then
      (MpCommon.AnomalyEventUpdate)("AnomalyTencode2", "Tencode2TableMarker", 1, 1)
      return mp.CLEAN
    end
    local l_0_8 = (MpCommon.AnomalyEventLookup)("AnomalyTencode2", l_0_6, 1)
    if l_0_8 == nil then
      (MpCommon.AnomalyEventUpdate)("AnomalyTencode2", l_0_6, 1, 1)
      local l_0_9, l_0_10, l_0_11 = (MpCommon.SNidSearch)(228, l_0_6)
      if l_0_9 == true and l_0_10 == "!#Tencode2CommonGlobal" then
        return mp.CLEAN
      end
      ...
      do
        ;
        (MpCommon.AnomalyEventUpdate)("AnomalyTencode2", l_0_6, l_0_8.Count + 1, 1)
        do
          local l_0_12, l_0_13, l_0_14 = (MpCommon.SNidSearch)(228, l_0_6)
          if l_0_12 == true and l_0_13 == "!#Tencode2CommonGlobal" then
            return mp.CLEAN
          end
