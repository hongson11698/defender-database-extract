...
-- Command line: db 092023\as_db\lua\!InfrastructureShared\5bb39e418661\0x00008093_luac 
...
if #l_0_4 > 0 then
  (bm.add_related_string)("RemoteClientData", safeJsonSerialize(l_0_4), bm.RelatedStringBMReport)
  reportTimingData()
  return mp.INFECTED
end
return mp.CLEAN
