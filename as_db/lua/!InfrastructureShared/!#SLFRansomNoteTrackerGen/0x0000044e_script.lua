...
-- Command line: db 092023\as_db\lua\!InfrastructureShared\!#SLFRansomNoteTrackerGen\0x0000044e_luac 
...
if l_0_9 then
  ...
  if #l_0_9 == 5 then
    (MpCommon.BmTriggerSig)(l_0_1, "BM_GenRansomNoteTrackerGenC", safeJsonSerialize(l_0_9))
    ;
