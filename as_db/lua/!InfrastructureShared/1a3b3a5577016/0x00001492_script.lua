...
-- Command line: db 092023\as_db\lua\!InfrastructureShared\1a3b3a5577016\0x00001492_luac 
...
if (string.match)(l_0_2, "^/home/") or (string.match)(l_0_2, "^/root/") or (string.match)(l_0_2, "^/tmp/") or (string.match)(l_0_2, "^/var/") or (string.match)(l_0_2, "^/dev/shm/") then
