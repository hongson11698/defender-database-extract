...
-- Command line: db 092023\as_db\lua\!InfrastructureShared\!#LuaContextOpenAfterDroppedRemotely\0x00001150_luac 
...
if IsKeyInRollingQueue("DroppedByPossibleRemotelyCreatedProc", l_0_0, true) then
