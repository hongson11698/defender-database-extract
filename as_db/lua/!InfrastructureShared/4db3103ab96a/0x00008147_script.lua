...
-- Command line: db 092023\as_db\lua\!InfrastructureShared\4db3103ab96a\0x00008147_luac 
...
do
  ...
  return l_1_1
    ...
    for l_0_9,l_0_10 in ipairs(l_0_5) do
      local l_0_6 = {SIG_CONTEXT = "BM", CONTENT_SOURCE = "WSCRIPT_SCHTASK", PROCESS_CONTEXT = "schtasks.exe", FILELESS = "true", CMDLINE_URL = "true"}
