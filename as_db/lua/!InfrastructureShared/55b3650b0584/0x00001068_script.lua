...
-- Command line: db 092023\as_db\lua\!InfrastructureShared\55b3650b0584\0x00001068_luac 
...
if l_0_0 then
  ...
  if IsHostAttackServer(l_0_1) then
    ...
    if l_0_2 ~= nil then
      ...
      ;
      (bm.trigger_sig)("active_attacker_server_connection_a", l_0_0, (this_sigattrlog[2]).ppid)
