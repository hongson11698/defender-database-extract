...
-- Command line: db 092023\as_db\lua\!InfrastructureShared\!#WebShellCreation\0x0000046a_luac 
...
if (mp.IsPathExcludedForHipsRule)(l_0_3, "a8f5898e-1dc8-49a9-9878-85004b8a61e6") then
  return mp.CLEAN
end
                    ...
                    if (MpCommon.GetPersistContextCount)(l_0_3) == 0 then
                      ...
                      do
                        do
                          ...
                          -- DECOMPILER ERROR at PC365: LeaveBlock: unexpected jumping out IF_ELSE_STMT
