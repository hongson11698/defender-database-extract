...
-- Command line: db 092023\as_db\lua\!InfrastructureShared\7cb3bc4d07d9\0x0000076e_luac 
...
do
  ...
  local l_0_3 = nil
  if l_0_3 ~= nil and (string.find)(l_0_3, "/create", 1, true) and (string.find)(l_0_3, "powershell", 1, true) then
    local l_0_4 = nil
  ...
  return l_1_1
    ...
    for l_0_9,l_0_10 in ipairs(l_0_5) do
      local l_0_6 = {SIG_CONTEXT = "BM", CONTENT_SOURCE = "PS_SCHTASK_ISSERVER", PROCESS_CONTEXT = "schtasks.exe", FILELESS = "true", CMDLINE_URL = "true"}
