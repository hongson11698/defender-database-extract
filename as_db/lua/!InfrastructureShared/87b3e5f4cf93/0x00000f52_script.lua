...
-- Command line: db 092023\as_db\lua\!InfrastructureShared\87b3e5f4cf93\0x00000f52_luac 
...
if l_0_0 ~= nil then
  ...
  local l_0_1 = (MpCommon.ExpandEnvironmentVariables)("%windir%\\system32\\sdiagnhost.exe")
