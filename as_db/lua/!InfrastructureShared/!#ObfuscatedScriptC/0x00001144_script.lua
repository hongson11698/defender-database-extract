...
-- Command line: db 092023\as_db\lua\!InfrastructureShared\!#ObfuscatedScriptC\0x00001144_luac 
...
local l_0_3 = BuildRepeatedTokenHistogram()
local l_0_4 = l_0_3[1]
...
for l_0_11,l_0_12 in ipairs(l_0_5) do
  if l_0_11 ~= nil and l_0_11 >= 5 then
...
do
  if l_0_6 * 100 / l_0_4 >= 50 or (l_0_6 + l_0_7) * 100 / l_0_4 >= 80 then
