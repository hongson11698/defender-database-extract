...
-- Command line: db 092023\as_db\lua\!InfrastructureShared\43d7379912d1\0x000006e6_luac 
...
if not (string.find)(l_0_1, "\\windows\\system32\\slui.exe", 1, true) then
  return mp.CLEAN
end
local l_0_2 = (sysio.RegExpandUserKey)("HKCU\\Software\\Classes\\exefile\\Shell\\Open\\Command")
if l_0_2 then
