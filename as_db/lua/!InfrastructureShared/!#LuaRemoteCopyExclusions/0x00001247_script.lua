...
-- Command line: db 092023\as_db\lua\!InfrastructureShared\!#LuaRemoteCopyExclusions\0x00001247_luac 
...
local l_0_6 = "idc_database.sqlite-journal|startupprofiledata-noninteractive|default.vg1|isbew64.exe|dismhost.exe|mighost.exe|qdaw3v01.exe|logmeinrescue.exe|isagenix.domainobjects.resources.dll"
